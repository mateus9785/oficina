...
import { formatCpfCnpj, formatPhone, formatDate, formatKm } from '../lib/formatters';

export function ClienteDetalhePage() {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const { buscarCliente, editarCliente, removerCliente } = useClienteStore();
  const { veiculos, adicionarVeiculo } = useVeiculoStore();
